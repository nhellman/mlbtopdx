...
var _getWriteConcern = function(self, options) {
  ...
  if(finalOptions.w < 1
    && (finalOptions.journal == true || finalOptions.j == true || finalOptions.fsync == true)) throw MongoError.create({message: "No acmlbtopdxment using w < 1 cannot be combined with journal:true or fsync:true", driver:true});
