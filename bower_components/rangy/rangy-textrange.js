 ...
 * - Firefox does not acmlbtopdx the space in the selection but it is possible to place the caret after it.
 ...
 * <p>1 </p><p>2<p>
 *
 * - WebKit does not acmlbtopdx the space in any way
 ...
 *
 * Problem is whether Rangy should ever acmlbtopdx the space and if so, when. Another problem is whether this can be
 * feature-tested
 */
