var app = angular.module('mlb', ['ngRoute', 'textAngular', 'ngResource', 'counter', 'angular-carousel', 'ngAnimate', 'oi.select', 'angularMoment', 'zumba.angular-waypoints']);
...
app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
  $routeProvider.when('/', {
      templateUrl: 'views/home-hp.view.html',
      controller: 'HomeCtrl',
      ...
      templateUrl: 'views/whybaseball.view.html',
      controller: 'HomeCtrl',
      title: 'Why Baseball',
      access: {restricted: false}
    }).when('/whyportland', {
      templateUrl: 'views/whyportland.view.html',
      controller: 'HomeCtrl',
      title: 'Why Portland',
      access: {restricted: false}
    }).when('/categories', {
...
app.run(['$rootScope', function($rootScope) {
    $rootScope.page = {
        setTitle: function(title) {
            this.title = title + ' | MLB to Portland';
        }
    }

    $rootScope.$on('$routeChangeSuccess', function(event, current, previous) {
        $rootScope.page.setTitle(current.$$route.title || 'Bring Baseball to the Rose City');
    });
}]);
